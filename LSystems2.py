"""
File: LSystems2.py
Creator: Susan Fox and other COMP 123 Instructors
Last edited: May 2021
Implements a general fractal-drawing L-System program, adds in the [ and ] operators that let us build fractal trees
"""
...
def main():
   ...
   # Build instructions with L-system
    instructs1 = createLSystem(4, hilbertAxiom, hilbertRules)
    
    displayFractal(instructs1, hilbertAngle, 10, (0, -400), 90)
